...
- [jstable](https://github.com/jinseob2kim/jstable): 회귀분석 테이블(CRAN)

- [jskm](https://github.com/jinseob2kim/jskm): 카플란-마이어(Kaplan-meier) 그림(CRAN)
...
- test coverage: [covr](https://covr.r-lib.org/)
...
`build_site()` 실행하면 **/doc** 폴더에 홈페이지 만들어짐. 
...
코드 실행 점검하고 리포트를 제공하는 [Codecov](https://codecov.io/)를 위한 R 패키지.

```{r, out.width="75%"}
include_graphics("codecov.png")
```

https://codecov.io/gh/jinseob2kim/jstable/tree/master/R
