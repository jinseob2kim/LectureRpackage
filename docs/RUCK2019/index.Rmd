...
---
class: bg-main1
# 함수 문서 작성: [sinew](https://github.com/metrumresearchgroup/sinew) addin with [roxygen2](https://CRAN.R-project.org/package=roxygen2) 
...
### .yellowNews.md]: CRAN의 NEWS

### .yellowcran-comments.md]: 패키지 자체 테스트 결과를 적는다.
